...
function InstagramBrandIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="24" height="24" rx="5" fill="url(#insta_gradient_signup)" />
      ...
      <defs>
        <linearGradient id="insta_gradient_signup" x1="2.5" y1="21.5" x2="21.6" y2="2.5" gradientUnits="userSpaceOnUse">
...
function MessengerBrandIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        <linearGradient id="messenger_gradient_signup" x1="12" y1="20.4925" x2="12" y2="2" gradientUnits="userSpaceOnUse">
