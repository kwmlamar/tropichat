...
export default function TemplatesPage() {
  ...
  if (!loading && whatsappConnected === false) {
    return (
      <div className="p-8 space-y-8 min-h-[calc(100vh-100px)] relative overflow-hidden bg-white dark:bg-black">
        ...
        <div className="relative z-10 text-center max-w-2xl mx-auto pt-20">
          <motion.div
            ...
            className="inline-flex items-center justify-center h-24 w-24 rounded-[32px] bg-white dark:bg-[#0A0A0A] shadow-[0_20px_40px_rgba(0,0,0,0.08)] border border-white dark:border-[#222222] mb-8"
          >
  ...
  return (
    <div className="p-8 space-y-8 relative min-h-[calc(100vh-80px)] overflow-x-hidden bg-white dark:bg-black">
      {/* Dynamic Background */}
      ...
      {/* Header Section */}
      <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2 border-b border-gray-100 dark:border-[#222222]/50">
        <div>
        ...
        <div className="flex items-center gap-3">
          <Button
            ...
            className="h-12 px-6 rounded-2xl border-gray-200 dark:border-[#222222] bg-white/50 dark:bg-[#0A0A0A]/50 backdrop-blur-sm hover:bg-white dark:hover:bg-[#111111] text-gray-600 dark:text-gray-300 font-bold transition-all hover:shadow-md active:scale-95 disabled:opacity-50"
          >
      ...
      <div className="relative z-10 flex flex-col xl:flex-row gap-4">
        <div className="relative flex-1 group">
          ...
          <Input
            ...
            className="h-14 pl-12 pr-4 bg-white/70 dark:bg-[#0A0A0A]/70 backdrop-blur-md rounded-2xl border-gray-100 dark:border-[#222222] shadow-[0_4px_20px_rgba(0,0,0,0.03)] focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 transition-all text-gray-900 dark:text-gray-100 font-medium placeholder:text-gray-400 dark:placeholder:text-gray-500"
          />
        </div>

        <div className="flex bg-gray-100/50 dark:bg-[#0A0A0A] backdrop-blur-sm p-1.5 rounded-2xl border border-gray-200/50 dark:border-[#222222] self-start">
            ...
            <button
              ...
              className={cn(
                ...
                statusFilter === filter.value
                  ? "bg-white dark:bg-[#111111] text-navy-900 dark:text-white shadow-sm"
      ...
      {loading ? (
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {[...Array(6)].map((_, i) => (
            <div
              key={i}
              className="bg-white/50 dark:bg-[#0A0A0A]/50 backdrop-blur-sm rounded-3xl border border-white dark:border-[#222222] p-8 shadow-sm flex flex-col h-[280px]"
            >
        ...
        <motion.div
          ...
          className="bg-white/50 dark:bg-[#0A0A0A]/50 backdrop-blur-xl rounded-[40px] border border-white dark:border-[#222222] p-20 text-center shadow-[0_32px_64px_rgba(0,0,0,0.06)]"
        >
          <div className="flex flex-col items-center max-w-sm mx-auto">
            <div className="h-24 w-24 rounded-full bg-gray-50 dark:bg-[#111111] flex items-center justify-center mb-8 border border-gray-100 dark:border-[#222222]">
          ...
          <AnimatePresence mode="popLayout">
            {filteredTemplates.map((template, index) => (
              <motion.div
                ...
                className="group relative bg-white/70 dark:bg-[#0A0A0A]/70 backdrop-blur-xl rounded-[32px] border border-white dark:border-[#222222] p-8 shadow-[0_8px_32px_rgba(0,0,0,0.04)] hover:shadow-[0_24px_48px_rgba(0,0,0,0.08)] transition-all flex flex-col h-full hover:-translate-y-1"
              >
                {/* Card Header */}
                <div className="flex items-start justify-between mb-6">
                  <div className="min-w-0 pr-4">
                    ...
                    <div className="flex items-center gap-2 mt-1.5">
                      ...
                      <span className="h-1 w-1 rounded-full bg-gray-200 dark:bg-[#222222]" />
                      <div className="flex items-center gap-1 text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">
                  ...
                  <Dropdown
                    align="right"
                    trigger={
                      <button className="h-10 w-10 flex items-center justify-center rounded-xl bg-gray-50/50 dark:bg-[#111111]/50 border border-gray-100 dark:border-[#222222] text-gray-400 dark:text-gray-500 hover:text-navy-900 dark:hover:text-white hover:bg-white dark:hover:bg-[#333333] transition-all">
                ...
                <div className="flex-1 relative mb-6">
                  <div className="absolute inset-0 bg-teal-50/30 dark:bg-[#111111]/30 rounded-2xl -z-10 group-hover:bg-teal-50/50 dark:group-hover:bg-[#111111]/50 transition-colors" />
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input
              ...
              className="mt-2 h-12 bg-white dark:bg-black border-gray-100 dark:border-[#222222] rounded-2xl focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 shadow-sm transition-all dark:text-white dark:placeholder:text-gray-500"
            />
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <SimpleSelect
                ...
                className="mt-2 h-12 bg-white dark:bg-black border-gray-100 dark:border-[#222222] rounded-2xl shadow-sm"
              />
            </div>
            <div>
          ...
          <div>
            ...
            <Textarea
              ...
              className="mt-2 min-h-[140px] bg-white dark:bg-black border-gray-100 dark:border-[#222222] rounded-2xl p-4 focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 shadow-sm resize-none transition-all dark:text-white dark:placeholder:text-gray-500"
            />
          ...
          <AnimatePresence>
            {newBody && (
              ...
              >
                ...
                <div className="bg-[#DCF8C6]/40 dark:bg-[#111111]/40 backdrop-blur-sm rounded-[24px_24px_24px_4px] p-6 border border-[#DCF8C6]/50 dark:border-[#222222] shadow-[0_8px_32px_rgba(37,211,102,0.06)] relative max-w-[90%]">
          ...
          <ModalFooter className="pt-6 gap-3 border-t border-gray-100 px-0 mt-8">
            <Button
              ...
              className="h-12 px-6 rounded-xl font-bold text-gray-400 hover:text-navy-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-[#111111] flex-1 sm:flex-none"
            >
              Discard Draft
            </Button>
            <Button
