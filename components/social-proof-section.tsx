...
const testimonials = [
  {
    ...
    quote: "Before TropiChat, I was drowning in messages. I'd miss orders, forget who wanted what, stress out my whole team. Now? Everything is labeled. I know exactly who to follow up with. My sales went up 40% in 2 months just from not losing track of people.",
  ...
  },
  {
    ...
    location: "Barbados",
    businessType: "🔧 Retail",
    quote: "I have 3 employees now and before TropiChat we were constantly confused about who said what to customers. Now everyone can see the conversation history. Game changer.",
    avatar: "👨🏽‍🔧",
    featured: false,
  },
  {
    ...
    quote: "The quick replies alone save me so much time. I'm not typing out my price list 20 times a day anymore. 5 minutes to set up, been using it for 6 months straight.",
    avatar: "👩🏿‍💼",
    featured: false,
  },
  {
    ...
    quote: "I thought I'd need some fancy CRM software. TropiChat works right in WhatsApp, which is where my customers already are. Simple is better.",
    avatar: "👨🏻‍🌾",
    featured: false,
  },
]
  ...
  return (
    <section className="relative bg-gradient-to-b from-white to-gray-50/50 py-20 md:py-28 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="animate-float-slow absolute left-1/4 top-0 h-[400px] w-[400px] rounded-full bg-[#25D366]/5 blur-3xl" />
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="mb-4 text-3xl font-bold tracking-tight text-gray-900 md:text-4xl lg:text-5xl">
            ...
            <br />
            <span className="text-[#25D366]">Just Like You</span>
          </h2>
            ...
            <motion.div
              ...
              className={`group relative overflow-hidden rounded-2xl bg-white p-8 shadow-lg transition-all duration-300 hover:shadow-2xl ${
                testimonial.featured
                  ? "border-2 border-[#25D366] md:col-span-2 lg:col-span-1"
                  : "border border-gray-200"
              }`}
            >
              {testimonial.featured && (
                <div className="absolute top-4 right-4 rounded-full bg-[#25D366] px-3 py-1 text-xs font-semibold text-white">
                  ⭐ Featured
                </div>
              )}
        ...
        <motion.div
          ...
          className="grid gap-6 md:grid-cols-4 rounded-2xl bg-green-50 p-8"
        >
          ...
          <div className="text-center">
            <div className="mb-2 text-2xl">📱</div>
            <div className="font-semibold text-gray-900">WhatsApp verified</div>
            <div className="text-sm text-gray-600">Official Business partner</div>
          </div>
