...
interface Tab {
    title: string;
    icon: React.ElementType; // Adjusted for better compatibility
    type?: never;
}
...
interface ExpandableTabsProps {
    ...
    selectedIndex?: number | null; // Added to allow external control
}
...
export function ExpandableTabs({
    ...
    // Sync internal state with external selectedIndex if provided
    React.useEffect(() => {
    ...
    useOnClickOutside(outsideClickRef as React.RefObject<HTMLDivElement>, () => {
        // Only clear if not externally controlled
        if (selectedIndex === undefined) {
