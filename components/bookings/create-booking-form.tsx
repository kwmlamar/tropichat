...
export function CreateBookingForm({
  ...
  return (
    <div className={cn("flex flex-col w-full", isPage ? "min-h-screen bg-[#F8FAFB] dark:bg-[#121212]" : "max-h-[80vh]")}>
      ...
      {/* ---- FORM STEP ---- */}
      {step === 'form' && (
        <div className={cn("p-5 sm:p-8 space-y-4 sm:space-y-6 overflow-y-auto custom-scrollbar flex-1", isPage && "pb-32")}>
          {/* Service */}
          <div>
      ...
      {step === 'confirm' && selectedService && (
        <div className={cn("p-5 sm:p-8 space-y-4 sm:space-y-6 overflow-y-auto custom-scrollbar flex-1", isPage && "pb-32 pt-8")}>
          {/* Summary Card */}
          ...
          <div className={cn("flex flex-col gap-3 pt-2", isPage ? "pb-32" : "")}>
            <Button
      ...
      {step === 'done' && createdBooking && (
        <div className="p-12 text-center space-y-6 flex-1 flex flex-col justify-center">
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
